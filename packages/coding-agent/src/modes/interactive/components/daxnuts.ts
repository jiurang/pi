 ...
 * POWERED BY DAXNUTS —— 为 OpenCode + Kimi K2.5 准备的彩蛋
 *
 * A heartfelt tribute to dax (@thdxr) for providing free Kimi K2.5 access via OpenCode.
 * 衷心致敬 dax (@thdxr),感谢他通过 OpenCode 提供免费的 Kimi K2.5 使用权限。
 */
...
// dax 的 32x32 RGB 图像,以十六进制编码(每像素 3 字节)
const DAX_HEX =
